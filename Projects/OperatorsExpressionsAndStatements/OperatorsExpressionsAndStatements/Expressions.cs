...
class Expressions
{
    static void Main()
    {
        ...
        Console.WriteLine("Point ({0}, {1}) is within K((1, 1), 3) and out of R(1, -1, 6, 2). {2}.", x, y, inCircleOutOfRectangle);
        ...
        bool is1 = (((v >> p) & 1) == 1);
        Console.WriteLine("Value of bit at position {0} is 1. {1}.", p, is1);
